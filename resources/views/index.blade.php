                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="menu-wrapper">
                                ...
                                <div class="main-menu">
                                    <nav class="d-none d-lg-block">
                                        <ul id="navigation">
                                            ...
                                            <li><a href="job_listing.html">Cari lowongan </a></li>
                                ...
                                <div class="header-btn d-none f-right d-lg-block">
                                    <a href="profile/signup" class="btn head-btn1">Daftar</a>
                                    <a href="/login" class="btn head-btn2">Masuk</a>
                                </div>
                            </div>
                        </div>
                        <!-- Mobile Menu -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="browse-btn2 text-center mt-50">
                            <a href="job_listing.html" class="border-btn2">Telusuri Lebih Banyak</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="cv-caption text-center">
                            ...
                            <p class="pera2">Buatlah Dirimu Menarik dengan Resume Online-mu!</p>
                            <a href="#" class="border-btn2 border-btn4">Unggah CV-Mu</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="job-items">
                                ...
                                <div class="job-tittle">
                                    ...
                                    <ul>
                                        ...
                                        <li>Rp10,000,000 - Rp15,000,000</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="job-items">
                                ...
                                <div class="job-tittle">
                                    ...
                                    <ul>
                                        ...
                                        <li>Rp35,000,000 - Rp40,000,000</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="items-link f-right">
                            ...
                            <div class="job-items">
                                ...
                                <div class="job-tittle">
                                    ...
                                    <ul>
                                        ...
                                        <li>Rp15,000,000 - Rp20,000,000</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="items-link f-right">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                ...
                                <div class="job-tittle">
                                    ...
                                    <ul>
                                        <li>Creative Agency</li>
                                        <li><i class="fas fa-map-marker-alt"></i>Kebon Jeruk, Jakarta</li>
                                        <li>Rp8,000,000 - Rp10,000,000</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="items-link f-right">
